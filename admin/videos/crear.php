...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $stmt = $db->prepare("INSERT INTO videos (titulo, url_embed, estado, fecha_publicacion, usuario_id) VALUES (?, ?, ?, ?, ?)");
        $stmt->execute([$tituloV, $url, $estado, $fecha, $_SESSION['usuario_id']]);
...
<div class="row mb-3"><div class="col-12"><h1 class="h3">Nuevo video</h1></div></div>
...
<form method="POST">
    <div class="card"><div class="card-body">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="url_embed" class="form-control" placeholder="https://www.youtube.com/watch?v=XXXXX  o  youtu.be/XXXXX  o  URL embed" required>
            <small class="text-muted">Puedes pegar la URL normal de YouTube, el iframe completo, o directamente la URL embed. El sistema la convierte.</small>
        </div>
        <div class="row">
